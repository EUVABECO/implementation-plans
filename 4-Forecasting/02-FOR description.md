...
For this, it contains an architecture composed of data ingestion, management and storage, a modelling and simulation framework that describes this data and translates it into interpretable model outputs, as well as internal and external interfaces for the involved stakeholders.

The Forecasting Tool is intended to support public health preparedness, evidence-based policymaking, healthcare resource allocation, outbreak response coordination, risk communication, long-term surveillance and preparedness activities. It should be understood as an operational, crisis-driven decision-support system designed to support policy decisions under uncertainty. The tool enables simulation of multiple intervention scenarios, including vaccination strategies, NPIs, and combined mitigation approaches. It also facilitates the evaluation of variants of concern (VOCs), behavioural changes, seasonality, healthcare system constraints, and population mobility patterns. While the primary use of the tool is centered on crisis response, it may also be extended to support routine public health planning and preparedness. Such use, however, requires the availability of high-quality, continuous surveillance data and their effective integration into the modelling framework. Overall, by integrating continuously updated surveillance data and recalibrating epidemiological models over time, the Forecasting Tool provides robust and adaptive decision support for public health authorities and healthcare systems.
