...
Not all NITAGs will reach this level of maturity in a near future. Yet, the EUVABECO project will contribute to the emergence of this approach with the publication in a [GitHub repository](https://github.com/EUVABECO/CDS_rules) of a common syntax for CDS rules, as well as the rulesets elaborated during the pilot projects.
