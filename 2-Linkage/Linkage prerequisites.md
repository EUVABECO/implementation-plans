...
Complementary to characteristics described in [Linkage functional description](Linkage%20description) – *Constraints*, the IT infrastructure requires a number of measures to be put in place:
